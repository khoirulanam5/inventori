		...
		<div class="card-body">
			<div class="table-responsive">
              ...
              <th class="text-center">Jabatan</th>
                ...
                <a class="btn btn-danger btn-sm m-1 hapus" href="<?= base_url('admin/karyawan/delete/'.$value->id_user) ?>"><i class="fas fa-trash"></i></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('admin/karyawan/add') ?>" method="post" enctype="multipart/form_data">
...
<div class="modal fade" id="edit<?= $value->id_user ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('admin/karyawan/edit/'.$value->id_user) ?>" method="post" enctype="multipart/form_data">
                <div class="form-group">
                    <label>Nama</label>
